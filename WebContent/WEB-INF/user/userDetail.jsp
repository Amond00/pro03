				...
				<table class="table">
					<tbody>
						<tr>
							...
							<td>
								<div class="form-row">
									<input type="text" name="usid" id="usid" placeholder="아이디 입력" value="${dto.id }" class="input" readonly required />
								</div>
							</td>
						</tr>
						<tr>
							<th>비밀번호</th>
							<td><input type="password" name="uspw" id="uspw" placeholder="비밀번호 입력" value="${dto.pw }" class="input" required /></td>
						</tr>
						<tr>
							<th>비밀번호 확인</th>
							<td><input type="password" name="uspw2" id="uspw2" placeholder="비밀번호  확인 입력" value="${dto.pw }" class="input" required /></td>
						</tr>
						<tr>
							<th>회원이름</th>
							<td><input type="text" name="usname" id="usname" placeholder="이름 입력" value="${dto.name }" class="input" required /></td>
						</tr>
						<tr>
							<th>이메일</th>
						...
						<tr>
							<th>회원등급</th>
							<td>
								<c:set var="level" value="${dto.level}" /> 
						...
						<tr>
							...
							<button id="post_btn" onclick="findAddress()" class="button is-info">우편번호 검색</button>
							</td>
						</tr>
					</tbody>
				</table>
